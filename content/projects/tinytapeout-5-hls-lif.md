...
This particular LIFN's verilog HDL was built with a high level synthesis tool I previously studied in a different class, PyMTL3 (https://pymtl.github.io/). 
